...
public interface IdeaLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.custom.idea.management.services.service.impl.IdeaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the idea local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link IdeaLocalServiceUtil} if injection and service tracking are not available.
	 */
