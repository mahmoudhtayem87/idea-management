 ...
 * <code>com.liferay.custom.idea.management.services.service.impl.IdeaLocalServiceImpl</code> and
...
public class IdeaLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.custom.idea.management.services.service.impl.IdeaLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Idea addIdea(Idea idea) {
	 ...
	 * @return the new idea
	 */
	public static Idea createIdea(long ideaId) {
	 ...
	 */
	public static Idea deleteIdea(Idea idea) {
	 ...
	 */
	public static Idea deleteIdea(long ideaId) throws PortalException {
	...
	public static Idea fetchIdea(long ideaId) {
	 ...
	 * @throws PortalException if a idea with the primary key could not be found
	 */
	public static Idea getIdea(long ideaId) throws PortalException {
		return getService().getIdea(ideaId);
	}

	public static Idea getIdeaEntry(long ideaId)
		throws com.liferay.custom.idea.management.services.exception.
			NoSuchIdeaException {

		return getService().getIdeaEntry(ideaId);
	}
	 ...
	 */
	public static List<Idea> getIdeas(int start, int end) {
	 ...
	 */
	public static Idea updateIdea(Idea idea) {
	...
	private static volatile IdeaLocalService _service;
