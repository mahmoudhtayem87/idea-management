...
public class IdeaCacheModel implements CacheModel<Idea>, Externalizable {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof IdeaCacheModel)) {
			return false;
		}

		IdeaCacheModel ideaCacheModel = (IdeaCacheModel)object;

		if (ideaId == ideaCacheModel.ideaId) {
			return true;
		}
	...
	public Idea toEntityModel() {
		...
		if (description == null) {
			...
			ideaImpl.setDescription(description);
		}
